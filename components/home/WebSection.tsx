...
export default function WebSection() {
  return (
    <WebBody className="webapp-bg">
      <WebGrid>
        ...
        <RightGrid>
          <Header style={{ fontWeight: '700' }}>
            Minitrader is the ‘Web3 Amazon’ for growing your wealth.
          </Header>
          <Paragraph>
          ...
          <Paragraph>
            Minitrader aggregates the best performing assets globally including
      ...
      <WebGridItem>
        <WebGridItemText>
          Minitrader is the ‘Web3 Amazon’ for growing your wealth. Never miss
        ...
        <WebGridItemText>
          ...
          <br />
          What’s in it for Minitrader? We earn performance fees of 8.0% on
